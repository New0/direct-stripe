...
Tags: payment button, stripe button , stripe, custom stripe button, stripe modal form, stripe checkout, direct checkout, easy payments, accept credit cards, donations, subscriptions
...
Stripe payment buttons. Accept payments, donations and subscriptions! Customize styles, manage automated emails.

== Description ==

**Display a simple button that triggers Stripe modal form to easily start charging on your site, without being redirected to third-party service.**

Easily add Stripe buttons to your website with a simple shortcode.
 ...
 **Three shortcode exemple to simply add to pages / posts content or template :**
