...
###Display the Stripe button on your site with a simple shortcode [direct-stripe] and set your options :
    ...
    - description : Product description displayed on modal form. Set by default to the site description but it is recommanded to set it up in the shortcode to differenciate buttons with same amount.
