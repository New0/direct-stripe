...
var setStripeButton = /*#__PURE__*/function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2___default()(setStripeButton, _Component);

  var _super = _createSuper(setStripeButton);

  function setStripeButton(props) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, setStripeButton);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(setStripeButton, [{
    ...
    value: function componentDidMount() {
      ...
      apiFetch({
        path: 'direct-stripe/v1/settings'
      }).then(function (response) {
        var style = response.direct_stripe_use_custom_styles;

        if (style === '1') {
          _this2.setState({
            buttonClass: 'direct-stripe-button direct-stripe-button-id '
          });
        } else if (style === '2') {
          _this2.setState({
            buttonClass: 'original-stripe-button direct-stripe-button-id '
          });
        } else {
          _this2.setState({
            buttonClass: 'stripe-button-ds direct-stripe-button-id '
          });
        }
      }).catch(function (error) {
        console.log(error);
    ...
    value: function render() {
      var _this$state = this.state,
          buttonClass = _this$state.buttonClass,
          apiButtons = _this$state.apiButtons,
      ...
      if (isLoading) {
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("p", {
          className: className
        }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Spinner, null), ds_admin_block_vars.strings.loading);
      }
      ...
      return [isSelected && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(BlockControls, {
        key: "controls"
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("select", {
        class: className,
        value: value,
        onChange: onChangeButton
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])("option", null, ds_admin_block_vars.strings.selectButton), Buttons.map(function (item) {
