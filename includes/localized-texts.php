...
$texts = array(
    'strings' => array(
        ...
        'dsButDAHint'           =>  __( 'Set to "No" to hide the amount in modal form button.', 'direct-stripe' ),
