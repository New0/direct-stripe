...
$texts = array(
    'strings' => array(
        ...
        'saveButton'            =>  __( 'Save Button Settings', 'direct-stripe' ),
        'buttonSelected'        =>  __( 'Selected button', 'direct-stripe' ),
        'buttonSelectedId'      =>  __( 'Selected button Value', 'direct-stripe' ),
        'selectButton'          =>  __( 'Select Button', 'direct-stripe' ),
        'buttonControlsTitle'   =>  __( 'Save / Delete Button', 'direct-stripe' ),
        ...
        'valueCSSIDLabel'       =>  __( 'Button ID', 'direct-stripe' ),  
