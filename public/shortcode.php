...
<form action="<?php echo add_query_arg($params); ?>" id="stripeForm" value="submit" method="POST" >
	<?php if(  isset($directStripeAttrValues['type']) && $directStripeAttrValues['type'] === 'donation' ) { ?>
  ...
  <script class="stripe-button" src="https://checkout.stripe.com/checkout.js" 
	...
	<?php if( isset($d_stripe_styles['direct_stripe_use_tc_checkbox']) && $d_stripe_styles['direct_stripe_use_tc_checkbox'] === '1' ) { ?>
